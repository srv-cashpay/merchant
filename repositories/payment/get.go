...
func (r *paymentRepository) Get(req *dto.Pagination) (RepositoryResult, int) {
	...
	for i := range payments {
		payments[i].PaymentName = helpers.TruncateString(payments[i].PaymentName, 47)
	}
